...
static FlutterDesktopWindowState* GetSavedWindowState(void* window) {
...
static void SendPointerEventWithData(void* window,
...
static void GLFWCursorEnterCallback(void* window, int entered) {
  /*FlutterPointerEvent event = {};
  event.phase =
...
static void GLFWCursorPositionCallback(void * window, double x,
                                         double y) {
  /*FlutterPointerEvent event = {};
  event.x = x;
  event.y = y;
...
static void GLFWMouseButtonCallback(void* window,
...
static void GLFWScrollCallback(void* window,
...
static void GLFWCharCallback(void* window, unsigned int code_point) {
...
static void GLFWKeyCallback(void* window,
                            int key,
                            int scancode,
                            int action,
                            int mods) {
...
static void SetHoverCallbacksEnabled(void * window, bool enabled) {
...
static void GLFWAssignEventCallbacks(void * window) {
  /*glfwPollEvents();
...
static void GLFWClearEventCallbacks(void * window) {
...
// the eyes.
static void GLFWClearCanvas(void* window) {
...
static FlutterEngine RunFlutterEngine(void* window,
